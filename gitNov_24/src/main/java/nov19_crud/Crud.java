...
public class Crud { //매퍼의 쿼리를 호출
	...
	private final String MAPPER_NAME="noticeMapper"; //매퍼의 이름을 선언. 환경설정파일의 namespace와 이름 매칭
	...
	public int deleteNotice(Integer dto) { //DAO의 기능
	...
	private SqlSession getSession() { 
		...
		String config = "mybatisConfig.xml"; //환경설정 파일을 열기 위해 해당 파일이름 명시
